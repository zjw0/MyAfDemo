...
public class SortView extends FrameLayout implements View.OnClickListener {
    ...
    //设置三个控件文字
    public void setTitle(String title, int type) {//type 1、左边控件 2、中间控件 3、右边控件
        switch (type) {
            case 1:
    ...
    //设置三个控件文字颜色
    public void setTitleColor(int color, int type) {//type 1、左边控件 2、中间控件 3、右边控件
        switch (type) {
            case 1:
    ...
    //设置三个控件右边drawable
    public void setTitleDrawable(int sort, int type) {//sort 0、默认 1、升序 2、降序  type 1、左边控件 2、中间控件 3、右边控件
        switch (type) {
            case 1:
